...
public class ProductInfoPage {
	...
	public String getProductHeader(){
		String header = eleUtil.waitForElementVisible(productHeader, AppConstant.DEFAULT_TIMEOUT).getText();
	...
	public int getProductImagesCount() {
		int imageCount = 
				eleUtil.waitForAllElementsVisible(productImages, AppConstant.MEDIUM_DEFAULT_TIMEOUT).size();
...
//	Availability: Out Of Stock
	private void getProductMetaData() {
		List<WebElement> MetaList = eleUtil.waitForAllElementsVisible(productMetaData, AppConstant.DEFAULT_TIMEOUT);
...
//	Ex Tax: $2,000.00
	private void getProductPriceData() {
		List<WebElement> priceList = eleUtil.waitForAllElementsVisible(productPriceData, AppConstant.DEFAULT_TIMEOUT);
